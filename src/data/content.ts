...
export const services=[
 {slug:'consulta',title:'Consulta integral',text:'Historia clínica, examen físico y un plan adaptado a cada etapa de vida.',icon:Stethoscope,img:'https://images.pexels.com/photos/6234611/pexels-photo-6234611.jpeg?auto=compress&cs=tinysrgb&w=1600',alt:'Equipo veterinario realizando una consulta clínica a un perro',intro:'Una consulta completa conecta lo que observas en casa con un examen físico ordenado. El objetivo es detectar cambios, priorizar problemas y decidir contigo qué seguimiento tiene sentido para ese paciente.',goodFor:['Controles preventivos de cachorros, adultos y pacientes senior.','Cambios de apetito, peso, energía, conducta, piel, digestión o movilidad.','Segundas evaluaciones y seguimiento de enfermedades ya diagnosticadas.'],steps:[{title:'Historia y contexto',text:'Revisamos motivo de consulta, antecedentes, dieta, medicamentos, entorno y cambios observados en casa.'},{title:'Examen de cabeza a cola',text:'Valoramos peso y condición corporal, constantes vitales, boca, ojos, oídos, piel, corazón, pulmones, abdomen y movilidad según la tolerancia del paciente.'},{title:'Prioridades compartidas',text:'Explicamos hallazgos, diagnósticos diferenciales y si conviene observar, realizar pruebas o iniciar un tratamiento.'}],preparation:'Trae registros previos, lista de medicamentos y suplementos, nombre del alimento y videos de signos que no siempre aparecen en consulta.',sources:[{label:'AAHA/AVMA · Preventive Healthcare Guidelines',url:'https://www.aaha.org/resources/2011-aaha-avma-preventive-healthcare-guidelines/'},{label:'FelineVMA · Feline Life Stage Guidelines',url:'https://catvets.com/resource/aaha-aafp-feline-life-stage-guidelines/'}]},
 {slug:'prevencion',title:'Vacunación y prevención',text:'Protección individual según especie, edad, entorno, viajes y exposición.',icon:Syringe,img:'https://images.pexels.com/photos/7469223/pexels-photo-7469223.jpeg?auto=compress&cs=tinysrgb&w=1600',alt:'Veterinario administrando una vacuna a un perro acompañado',intro:'El calendario preventivo no debe copiarse de una mascota a otra. Se construye revisando antecedentes, riesgo de exposición, normativa local y cambios de estilo de vida.',goodFor:['Inicio o continuación del esquema de cachorros y gatitos.','Refuerzos, registros incompletos o vacunas atrasadas.','Cambios de hogar, viajes, guardería, hospedaje o mayor contacto con otros animales.'],steps:[{title:'Revisión de riesgo',text:'Confirmamos edad, historial, enfermedades, reacciones previas, convivencia, acceso al exterior y exposición esperada.'},{title:'Plan individual',text:'Diferenciamos vacunas esenciales de aquellas indicadas por riesgo y explicamos intervalos, beneficios y precauciones.'},{title:'Registro y vigilancia',text:'Documentamos la aplicación y entregamos indicaciones claras sobre reacciones leves esperables y señales que requieren atención.'}],preparation:'Lleva el carné o cualquier comprobante disponible. Informa si hubo una reacción previa, enfermedad reciente o tratamiento en curso.',sources:[{label:'AAHA · Canine Vaccination Guidelines, actualizadas en 2024',url:'https://www.aaha.org/resources/2022-aaha-canine-vaccination-guidelines/'},{label:'FelineVMA · Feline Vaccination Guidelines',url:'https://catvets.com/resource/aaha-aafp-feline-vaccination-guidelines/'}]},
 {slug:'laboratorio',title:'Laboratorio clínico',text:'Hematología, bioquímica, orina y pruebas dirigidas interpretadas en contexto.',icon:Microscope,img:'https://images.unsplash.com/photo-1576086213369-97a306d36557?auto=format&fit=crop&w=1600&q=86',alt:'Profesional analizando muestras con un microscopio de laboratorio',intro:'Una prueba de laboratorio aporta piezas del diagnóstico; no reemplaza la historia ni el examen. Elegimos las muestras y análisis según la pregunta clínica y explicamos qué significan juntos, no como cifras aisladas.',goodFor:['Síntomas como debilidad, vómito, diarrea, fiebre, pérdida de peso o aumento de sed.','Evaluaciones preanestésicas y líneas base según edad o riesgo.','Control de enfermedades crónicas y respuesta a tratamientos.'],steps:[{title:'Pregunta clínica',text:'Definimos qué necesitamos investigar para evitar paneles indiscriminados o resultados que no cambien la conducta médica.'},{title:'Muestra adecuada',text:'Seleccionamos sangre, orina, heces, citología u otra muestra y cuidamos identificación, conservación y método de obtención.'},{title:'Interpretación integrada',text:'Relacionamos hemograma, bioquímica, urianálisis u otras pruebas con signos, examen y resultados previos; si hace falta, recomendamos confirmación.'}],preparation:'No ayunes ni suspendas medicamentos salvo indicación expresa. Pregunta antes si debes llevar una muestra y cómo recolectarla sin contaminarla.',sources:[{label:'Merck Veterinary Manual · Common Laboratory Tests',url:'https://www.merckvetmanual.com/special-pet-topics/diagnostic-tests-and-imaging/common-laboratory-tests-in-veterinary-medicine'},{label:'AAHA · Baseline Data and Diagnostic Testing',url:'https://www.aaha.org/resources/life-stage-canine-2019/baseline-data/'}]},
 {slug:'cirugia',title:'Cirugía y recuperación',text:'Evaluación preoperatoria, anestesia individual, monitorización y control del dolor.',icon:HeartPulse,img:'https://images.pexels.com/photos/7121992/pexels-photo-7121992.jpeg?auto=compress&cs=tinysrgb&w=1600',alt:'Equipo veterinario monitorizando a un perro durante anestesia',intro:'La seguridad quirúrgica es un proceso continuo: empieza antes de la anestesia, sigue durante el procedimiento y continúa en recuperación y en casa.',goodFor:['Procedimientos electivos indicados después de una valoración clínica.','Cirugía de tejidos blandos, heridas, masas u otras condiciones según diagnóstico.','Pacientes que requieren un plan anestésico y analgésico adaptado a sus riesgos.'],steps:[{title:'Evaluación preoperatoria',text:'Revisamos examen, antecedentes, medicamentos y pruebas necesarias para clasificar riesgos y planificar el procedimiento.'},{title:'Anestesia y monitorización',text:'El protocolo se adapta al paciente y se vigilan parámetros respiratorios, cardiovasculares y temperatura, además de la valoración directa del equipo.'},{title:'Recuperación y dolor',text:'La vigilancia continúa hasta que el paciente cumple criterios clínicos de recuperación; al alta explicamos medicación, herida, actividad y signos de alarma.'}],preparation:'Sigue únicamente las instrucciones de ayuno y medicación enviadas para tu mascota. Confirma la hora, el procedimiento, un teléfono disponible y las condiciones del cuidado en casa.',sources:[{label:'AAHA · Anesthesia and Monitoring Guidelines',url:'https://www.aaha.org/resources/2020-aaha-anesthesia-and-monitoring-guidelines-for-dogs-and-cats/'},{label:'AAHA · Pain Management Guidelines',url:'https://www.aaha.org/resources/2022-aaha-pain-management-guidelines-for-dogs-and-cats/home-3/'}]},
 {slug:'odontologia',title:'Salud dental',text:'Evaluación oral, prevención y tratamiento de dolor o enfermedad periodontal.',icon:Scissors,img:'https://unsplash.com/photos/yme-xntjSKY/download?force=true&w=1600',alt:'Veterinario examinando cuidadosamente los dientes de un perro',intro:'El mal aliento persistente, el sarro y los cambios al masticar pueden acompañar enfermedad dolorosa. Una revisión oral permite decidir si basta con prevención o si se necesita una evaluación dental más profunda.',goodFor:['Mal aliento persistente, sarro visible o encías rojas y sangrantes.','Babeo, comida que cae, preferencia por un lado o rechazo a objetos duros.','Controles preventivos y seguimiento después de un procedimiento dental.'],steps:[{title:'Evaluación despierta',text:'Observamos rostro, mordida, dientes, encías y signos de dolor hasta donde el paciente permite hacerlo sin forzar.'},{title:'Plan dental seguro',text:'Si está indicado, explicamos la evaluación preanestésica y el alcance de una limpieza y exploración completas, incluyendo radiografías dentales cuando estén disponibles.'},{title:'Prevención posible',text:'Adaptamos cepillado y productos veterinarios a la tolerancia del animal; nunca recomendamos desprender sarro o usar pasta humana en casa.'}],preparation:'Cuenta qué come, cómo mastica y desde cuándo notas cambios. No intentes raspar el sarro ni manipular una boca dolorida antes de la cita.',sources:[{label:'WSAVA · Global Dental Guidelines',url:'https://wsava.org/global-guidelines/dental-guidelines/'},{label:'AVMA · Pet Dental Care',url:'https://www.avma.org/resources-tools/pet-owners/petcare/pet-dental-care'}]},
 {slug:'imagen',title:'Diagnóstico por imagen',text:'Radiografía y ecografía seleccionadas según el órgano y la pregunta clínica.',icon:ScanLine,img:'https://images.pexels.com/photos/6234610/pexels-photo-6234610.jpeg?auto=compress&cs=tinysrgb&w=1600',alt:'Equipo veterinario realizando una ecografía a un perro',intro:'La imagen diagnóstica permite observar estructuras internas sin una cirugía exploratoria. La modalidad correcta depende de qué tejido se necesita estudiar y de lo que revelaron la historia, el examen y otras pruebas.',goodFor:['Dolor, cojera o traumatismos que requieren evaluar huesos y articulaciones.','Vómitos persistentes, cambios urinarios, masas o alteraciones abdominales.','Tos, dificultad respiratoria y seguimiento de hallazgos previamente identificados.'],steps:[{title:'Elegir la modalidad',text:'Las radiografías suelen ser una primera herramienta para huesos, tórax y algunas alteraciones abdominales; la ecografía muestra órganos y movimiento en tiempo real.'},{title:'Preparar al paciente',text:'Explicamos si requiere ayuno, rasurado localizado, vejiga llena o sedación. Muchas radiografías y ecografías se realizan despierto, según tolerancia y precisión necesaria.'},{title:'Correlacionar hallazgos',text:'Una imagen no se interpreta sola. Integramos el informe con signos y análisis, y explicamos si responde la pregunta o si se necesita otra prueba.'}],preparation:'Pregunta si necesita ayuno o cambios en la toma de agua. Lleva estudios anteriores para comparar y no administres sedantes por tu cuenta.',sources:[{label:'Cornell University · Veterinary Imaging Service',url:'https://www.vet.cornell.edu/hospitals/services/imaging-service'},{label:'UC Davis · Small Animal Ultrasound',url:'https://behavior.vetmed.ucdavis.edu/hospital/diagnostic-imaging/small-animal/ultrasound'}]}
];
export const team=[
